...
import { getAccounts, getBalance, signAndSendTransaction } from "./polkadotRPC";
  ...
  return (
    <div className="w3a-example container">
      ...
      <footer className="footer">
        <a
          href="https://github.com/Web3Auth/web3auth-examples/tree/main/other/polkadot-example"
          target="_blank"
