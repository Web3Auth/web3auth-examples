# MetaMask Embedded Wallets — Facebook OAuth (Implicit)

React + Vite example using MetaMask Embedded Wallets (powered by Web3Auth) with a **custom Facebook OAuth connection** via the implicit flow.
...
- A custom Facebook connection configured on the Dashboard ([Authentication guide](https://docs.metamask.io/embedded-wallets/authentication/))
