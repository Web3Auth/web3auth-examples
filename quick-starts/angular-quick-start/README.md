...
Open `src/environments/environment.ts` and replace the placeholder `clientId` value with your own Client ID from the [Dashboard](https://dashboard.web3auth.io).
